...
public:
    vector() : vec_() {}
    vector(const f32 x, const f32 y, const f32 z) : vec_{x,y,z} {}
    vector(const f32 x, const f32 y, const f32 z, const f32 w) : vec_{x,y,z,w} {}
...
//    xvec3(const glm::vec3 &vec) : vec_(vec) {}
    ...
    void SetZ(f32 z) { vec_.z = z; }
    void SetW(f32 w) { vec_.w = w; }
    [[nodiscard]] scalar GetX() const { return vec_.x; }
    [[nodiscard]] scalar GetY() const { return vec_.y; }
    [[nodiscard]] scalar GetZ() const { return vec_.z; }
    [[nodiscard]] scalar GetW() const { return vec_.z; }
