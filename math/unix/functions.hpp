...
#include "math/win32/matrix.hpp"
#include "math/win32/scalar.hpp"
#include "math/win32/vector.hpp"
...
inline mat4 affineTransformation(xvec3 const position, xvec3 const scale, xvec3 const rotation) {
