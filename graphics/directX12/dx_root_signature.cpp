...
void RootSignature::finalize(ID3D12Device *device) {
    ...
    CD3DX12_ROOT_SIGNATURE_DESC rootSigDesc(num_parameters_, parameters_.get(), static_samplers.size(),
    ...
    device->CreateRootSignature( 0, serialized_root_sig->GetBufferPointer(), serialized_root_sig->GetBufferSize(),
