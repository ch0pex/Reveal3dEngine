 ...
 *  @glfw3 Added window hwnd parameter.
 *
 *  @ingroup window
 */
 ...
 *
 *  @since Added in version 1.0.
 *  @glfw3 Added window hwnd and modifier mask parameters.
 *
 *  @ingroup input
 */
 ...
 *
 *  @since Added in version 1.0.
 *  @glfw3 Added window hwnd, scancode and modifier mask parameters.
 *
 *  @ingroup input
 */
 ...
 *  @return The hwnd of the created window, or `NULL` if an
 *  [error](@ref error_handling) occurred.
 *
 ...
 *
 *  This function returns the hwnd of the monitor that the specified window is
 *  in full screen on.
 *
 *  @param[in] window The window to query.
 ...
 *
 *  @since Added in version 1.0.
 *  @glfw3 Added window hwnd parameter and return value.
 *
 *  @ingroup window
 */
 ...
 *  a surface_.  It is not affected by the scaling and acceleration applied to
 ...
 *  surface_ creation or even instance creation is possible.  Call @ref
 *  glfwGetRequiredInstanceExtensions to check whether the extensions necessary for Vulkan
 *  surface_ creation are available and @ref glfwGetPhysicalDevicePresentationSupport to
 ...
 *
 *  If Vulkan is available but no set of extensions allowing window surface_
 ...
 *
 *  If Vulkan or the required window surface_ creation instance extensions are
...
/*! @brief Creates a Vulkan surface_ for the specified window.
 *
 *  This function creates a Vulkan surface_ for the specified window.
 *
 ...
 *
 *  If the required window surface_ creation instance extensions are not
 ...
 *  required.
 *
 *  The window surface_ cannot be shared with another API so the window must
 *  have been created with the [client api hint](@ref GLFW_CLIENT_API_attrib)
 *  set to `GLFW_NO_API` otherwise it generates a @ref GLFW_INVALID_VALUE error
 *  and returns `VK_ERROR_NATIVE_WINDOW_IN_USE_KHR`.
 *
 *  The window surface_ must be destroyed before the specified Vulkan instance.
 *  It is the responsibility of the caller to destroy the window surface_.  GLFW
 *  does not destroy it for you.  Call `vkDestroySurfaceKHR` to destroy the
 *  surface_.
 *
 *  @param[in] instance The Vulkan instance to create the surface_ in.
 *  @param[in] window The window to create the surface_ for.
 *  @param[in] allocator The allocator to use, or `NULL` to use the default
 *  allocator.
 *  @param[out] surface_ Where to store the hwnd of the surface_.  This is set
 ...
 *  @ingroup vulkan
 */
GLFWAPI VkResult glfwCreateWindowSurface(VkInstance instance, GLFWwindow* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface_);
