...
class RenderSurfaceHost : HwndHost
{
    ...
    public int SurfaceId { get; private set; } = -1; 
    ...
    */
    ...
    {
        SurfaceId = EngineAPI.CreateViewport(hwndParent.Handle, _width, _height);
        // Debug.Assert(ID.IsValid(SurfaceId));
        _renderWindowHandle = EngineAPI.GetWindowHandle();
